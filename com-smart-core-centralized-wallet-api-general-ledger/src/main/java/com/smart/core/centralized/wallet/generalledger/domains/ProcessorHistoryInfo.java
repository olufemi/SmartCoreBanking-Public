...
@Data
@NoArgsConstructor
public class ProcessorHistoryInfo implements Serializable {
    ...
    public ProcessorHistoryInfo(String actionType, String actionTypeDesc, String transactionId, String userId, String channel,
            String source) {

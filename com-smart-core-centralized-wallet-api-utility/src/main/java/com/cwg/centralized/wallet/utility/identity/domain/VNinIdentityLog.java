...
@Data
@NoArgsConstructor
public class VNinIdentityLog implements Serializable {

    private static final long serialVersionUID = 9891421357L;
    private static final String SEQUENCE_NAME = "VNINIDLOG_SEQ_GEN";
    private static final String GENERATOR_NAME = "VNINIDLOG_GENRT";
